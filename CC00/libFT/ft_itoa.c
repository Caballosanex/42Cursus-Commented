...
/*   Updated: 2022/10/07 10:00:18 by alexsanc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

/*	We calculate the length of the number by dividing it by
10 over and over again until it is equal to zero.
...
We create a pointer to the end of the string and initialize
it with the length of the string.
...
If the number is equal to 0, we set the first character of
the string to the digit zero.
Then we convert the number to a string by using the
